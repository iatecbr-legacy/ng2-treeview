...
var TreeviewItem = (function () {
    ...
    Object.defineProperty(TreeviewItem.prototype, "outChecked", {
        get: function () {
    ...
    TreeviewItem.prototype.setCheckedRecursive = function (value) {
        ...
        if (!this.internalDisabled) {
            ...
            if (!_.isNil(this.internalChildren)) {
                this.internalChildren.forEach(function (child) { child.setCheckedRecursive(value); _this.internalOutChecked = value; });
            }
        }
    };
