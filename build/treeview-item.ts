...
export class TreeviewItem {
    public internalDisabled = false;
    public internalChecked = true;
    public internalOutChecked = false;
    public internalCollapsed = false;
    ...
    constructor(item: TreeItem, autoCorrectChecked = false) {
        ...
        if (_.isBoolean(item.outChecked)) {
            this.outChecked = item.outChecked;
        }
    ...
    get outChecked(): boolean {
        return this.internalOutChecked;
    }

    set outChecked(value: boolean) {
        if (this.internalOutChecked !== value) {
            this.internalOutChecked = value;
        }
    }
    ...
    setCheckedRecursive(value: boolean) {
        if (!this.internalDisabled) {
            ...
            if (!_.isNil(this.internalChildren)) {
                this.internalChildren.forEach(child => {child.setCheckedRecursive(value); this.internalOutChecked = value;});
            }
        }
    }
